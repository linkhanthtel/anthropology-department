...
function Home() {
  return (
    <div>
      {/* hero */}
      <div className='h-full w-screen py-36 text-center bg-white'>
        <h1 className='text-3xl text-black font-bold py-5'>Department of Anthropology</h1>
        <p className='text-black text-xl md:px-40'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad, placeat labore! Quaerat molestiae aspernatur enim? Ea numquam libero dolorem cumque harum blanditiis fuga, voluptas aliquam aspernatur, officia unde esse nobis.</p>
        <button className='p-3 my-5 bg-yellow-600 rounded-full text-white transition ease-in-out delay-150 hover:bg-yellow-800 hover:-translate-y-1 hover:scale-110 duration-300'>Learn More</button>
      </div>
